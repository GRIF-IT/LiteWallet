...
const char COMMUNITY_FORUM_URL[] = "https://investcoin.pro";
const char REPORT_ISSUE_URL[] = "https://investcoin.pro";

const char DONATION_URL_DONATION_TAG[] = "donation";
const char DONATION_URL_LABEL_TAG[] = "label";
const char DONATION_ADDRESS[] = "invcDWFBbP3HnPooutcCrd7LHn1JLt8jcDtfaFYKNcM5emJp8HRWwQoDZouGJR5mmU9bMwRm6AbaTB1Mp7NiGMd32d52kNtNXa";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Investcoin Lite Wallet %1").arg(Settings::instance().getVersion()));

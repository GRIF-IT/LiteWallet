...
public:
    ...
    QAction *m_aboutInvestcoinAction;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/Investcoin"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutInvestcoinAction = new QAction(MainWindow);
        m_aboutInvestcoinAction->setObjectName(QStringLiteral("m_aboutInvestcoinAction"));
        m_aboutInvestcoinAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutInvestcoinAction);
        ...
        QObject::connect(m_aboutInvestcoinAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
...
#endif // QT_NO_TOOLTIP
        m_aboutInvestcoinAction->setText(QApplication::translate("MainWindow", "About Investcoin Lite Wallet", nullptr));
